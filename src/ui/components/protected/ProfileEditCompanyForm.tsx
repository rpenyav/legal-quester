...
const ProfileEditCompanyForm: FC<PropsEdition> = ({ dataUser }) => {
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-md-6">
                      <BootstrapForm.Group controlId="industryType">
                        <BootstrapForm.Label>industryType</BootstrapForm.Label>
                        <Field
                          name="industryType"
                          type="text"
                          as={BootstrapForm.Control}
                  ...
                  <div className="row mb-3">
                    <div className="col-md-6">
                      <BootstrapForm.Group controlId="companySize">
                        <BootstrapForm.Label>companySize</BootstrapForm.Label>
                        <Field
                          name="companySize"
                          type="text"
                          as={BootstrapForm.Control}
                    ...
                    <div className="col-md-6">
                      <BootstrapForm.Group controlId="companyWebsite">
                        <BootstrapForm.Label>
                          companyWebsite
                        </BootstrapForm.Label>
                        <Field
